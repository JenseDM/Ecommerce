...
{
     public record AddAddressCommand(AddressEntity address, Guid userId): IRequest<ResponseFormat<AddressEntity>>;
        ...
        : IRequestHandler<AddAddressCommand, ResponseFormat<AddressEntity>>
    {
        ...
        {
            return await addressRepository.AddAddressAsync(request.address, request.userId);
        }
    }
}
